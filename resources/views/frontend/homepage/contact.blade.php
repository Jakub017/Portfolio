<section id="contact">
    ...
    <p>Pamiętaj, że <span class="colored">wycena jest darmowa</span>, więc skontaktuj się ze mną za pomocą tego formularza lub napisz do mnie bezpośrednio na <a class="mail-link" href="mailto:kontakt@lipinskijakub.pl">kontakt@lipinskijakub.pl</a><p>
    <form action="" method="POST">
      <div class="half-inputs">
        <input class="email" name="email" type="email" placeholder="Email (wymagane)" required>
        <input class="phone" name="phone" type="tel" placeholder="Numer telefonu (wymagane)" required>
      </div>
